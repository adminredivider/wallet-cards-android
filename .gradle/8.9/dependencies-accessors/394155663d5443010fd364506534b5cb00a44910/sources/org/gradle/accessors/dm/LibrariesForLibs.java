...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final HadoopLibraryAccessors laccForHadoopLibraryAccessors = new HadoopLibraryAccessors(owner);
    private final HiveLibraryAccessors laccForHiveLibraryAccessors = new HiveLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>viewpagerdotsindicator</b> with <b>com.tbuonomo:dotsindicator</b> coordinates and
     * with version reference <b>viewpagerdotsindicator</b>
     * <p>
     * This dependency was declared in catalog libs.versions.toml
     */
    public Provider<MinimalExternalModuleDependency> getViewpagerdotsindicator() {
        return create("viewpagerdotsindicator");
    }
    ...
    /**
     * Group of libraries at <b>hadoop</b>
     */
    public HadoopLibraryAccessors getHadoop() {
        return laccForHadoopLibraryAccessors;
    }

    /**
     * Group of libraries at <b>hive</b>
     */
    public HiveLibraryAccessors getHive() {
        return laccForHiveLibraryAccessors;
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>core</b> with <b>com.google.zxing:android-core</b> coordinates and
    ...
    public static class AndroidxBiometricLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>ktx</b> with <b>androidx.biometric:biometric</b> coordinates and
    ...
    public static class HadoopLibraryAccessors extends SubDependencyFactory {

        public HadoopLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>core</b> with <b>org.apache.hadoop:hadoop-core</b> coordinates and
         * with version reference <b>hadoopCore</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCore() {
            return create("hadoop.core");
        }

    }

    public static class HiveLibraryAccessors extends SubDependencyFactory {

        public HiveLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>jdbc</b> with <b>org.apache.hive:hive-jdbc</b> coordinates and
         * with version reference <b>hiveJdbc</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getJdbc() {
            return create("hive.jdbc");
        }
    ...
    public static class KoinLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>koinAnnotations</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>androidCore</b> with value <b>3.3.3</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>hadoopCore</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHadoopCore() { return getVersion("hadoopCore"); }

        /**
         * Version alias <b>hiveJdbc</b> with value <b>1.2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getHiveJdbc() { return getVersion("hiveJdbc"); }
        ...
        /**
         * Version alias <b>koinAnnotations</b> with value <b>2.0.0-Beta2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getKoinAnnotations() { return getVersion("koinAnnotations"); }
        ...
        /**
         * Version alias <b>safeArgsVer</b> with value <b>2.6.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>viewpagerdotsindicator</b> with value <b>5.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getViewpagerdotsindicator() { return getVersion("viewpagerdotsindicator"); }
